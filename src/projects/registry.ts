...
import { sweccUiExperimentationProjectDef } from './swecc-ui-experimentation/project'
 ...
 */
export const PROJECTS: ProjectDef[] = [isocourtProjectDef, uiExperimentsProjectDef, sweccUiExperimentationProjectDef]
