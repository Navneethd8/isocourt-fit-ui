...
import s from './swecc-prime.module.css'

/** Telemetry rail card — sage strip + violet headline chrome for the Prime tier kit. */
  ...
  return (
    <article className={cn(s.card, s.root, theme, className)}>
      ...
      <div className={s.cardMain}>
        <p className={s.cardEyebrow}>UW · PRIME DECK</p>
